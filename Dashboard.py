...
def page_scrape():
    ...
    with st.form(key='my_form'):
        ...
        df_index = int(dataset[-1])-1
        st.info("Please note: If the selected data container already has data stored, this data will be permanently overwritten. If you wish to keep the data, please select another container above or download the data from the sidebar.")
