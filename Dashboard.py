...
def page_how():
    ...
    with st.beta_expander("Wordcloud Analysis", expanded = False):
        ...
        col1.write("The Individual Datasets subpage allows you to visualize wordclouds from single datasets. Here, you can choose one of the datasets currently stored in the app, and use the tool to see which words most frequenctly occur in that data. The size of each word corresponds to its frequency within the data, with more common words shown as larger, and less common words as smaller.")
